...
//                             <Grid container direction="row" style={{height:"13px", color:'grey',textAlign:'center', fontSize:'15px'}}>

                          
//                                  {/* Design */}
//                                 {/* <div className="mb" onClick={changeTable(1)}> Design</div>   */}
//                                 {/* </Grid>
//                             <Grid item sm={6} md={6}>  */}
//                             {/* Grid */}
//                                  {/* <div className="mb" onClick={changeTable(0)}>Grid</div>
//                             </Grid> */} 
//                               <Grid item sm={6} md={6}> <button  id={monindex?'bl':''} className='b1' onClick={()=>changeTable(1)}>Design</button> </Grid>
//                               <Grid item sm={6} md={6} > <button  id={monindex?'':'bl'} className='b2' onClick={()=>changeTable(0)}>Grid</button> </Grid>
                                
//                             </Grid>
//                               <Grid container direction="row" style={{height:"20px"}}></Grid>
...
//                     <button type="button" id="whatapp" class="btn btn-info btn-sm" onClick={() => saveOrUpdatefunnel()}>update</button>
//         }
//             </div>
