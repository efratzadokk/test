...
<Container>
  <Row style={{fontSize:"17px",color:'#4169E1', fontWeight:'bold'}} >Image </Row>
  <hr/>
  <Row >
  {ImgOnEdit.value ?  <img style={{ width: "150px", height: "90px", margin: "0 9%" }} src={ImgOnEdit.value}  alt="Image"></img>
  : 
...
<Grid container direction="row" style={{height:"50px"}}  >
    <Grid item md={2} sm={2} style={{marginTop:'5px'}}>     <input type="checkbox" id="imgBorder"  onClick={(e) => HavingBorder(e)} /> </Grid>
<Grid item md={10} sm={10} style={{marginTop:'0px'}} >  <label  for="imgBorder" style={{color:'grey' ,marginTop:'0px'}}>Border</label> </Grid>
{
    ImgOnEdit.border?<> 
    ...
    <Grid container direction="row" style={{height:"15px"}} >
               ...
               <select name="border" id="border" style={{width:'100%',border:'none'}}
               // defaultValue={setBColor('solid','borderStyle')} 
                onChange={e=>setBColor(e.target.value,'borderStyle') }>
                   ...
                   <Grid item md={2} sm={2} > <input type='text' placeholder='px'
                    style={{ height:'18px', width:'40px', border:'none' , color:'grey'}}
                    onChange={(e)=> setBColor(`${e.target.value}px`,'borderWidth')}
                    /></Grid>
               </Grid>
               
    <Grid container direction="row" style={{height:"15px"}} >
                <Grid item sm={2}> <p >Color</p></Grid>
                <Grid item md={5}/>
