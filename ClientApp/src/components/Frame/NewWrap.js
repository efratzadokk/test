...
import Logo from '../Frame/assets/logo.png'
import Load from '../helpComponents/Loading'
import Profile from '../Frame/assets/profil.png'
                        ...
                        <div className="row ">
                            ...
                            <div className="col container">
                                <div className="row">
                                    ...
                                    <div className="col-2 mt-1 ml-4 p-0 h-25 w-25 d-flex justify-content-center">
                                        <img src={Logo} alt="leader" className="img-fluid rounded-circle d-flex justify-content-center"></img>
                                    </div>
                                    <PopupState variant="popover" popupId="demo-popup-popover">
                                        {(popupState) => (
                                            <div>
                                                <AppsIcon className="m-0 p-0 mt-1 ml-2 " fontSize="large"{...bindTrigger(popupState)}>></AppsIcon>
                                                ...
                                                >
                                                    ...
                                                    <Box p={2} style={{ width: "300px" }} className="row d-flex justify-content-around">
                                                        ...
                                                        <div className="col" style={{ color: "#3A405E" }}>
                                                            <a href="https://sites.leader.codes/">
                            ...
                            <div className="col container ">
                                <div className="row d-flex flex-row-reverse">
                                    ...
                                    <div className="col-3 m-0 p-0 d-flex justify-content-end">
                                        <img src={Profile} alt="hi" className="img-fluid"></img>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row d-flex justify-content-center navLeft_icon_content ">
                            <div className="col-3 container">
                                <div className="row d-flex justify-content-center" style={{ marginTop: "10px" }}>
                                    <a href="https://box.leader.codes/simdsMrrcJdpQgta8kgXyQBdDFy2">
                                ...
                                <div className="row d-flex justify-content-center" style={{ marginTop: "20px" }}>
                                    <a href="https://leader.codes/landingPage/rC8XjJ3sJoUfGqKmqsURsWfe3bS2/new">
                                ...
                                <div className="row d-flex justify-content-center " style={{ marginTop: "25px" }}>
                                    <a href="https://hub.leader.codes/projects/simdsMrrcJdpQgta8kgXyQBdDFy2">
                                ...
                                <div className="row d-flex justify-content-center " style={{ marginTop: "23px" }}>
                                    <a href="https://calendar.leader.codes/">
                                ...
                                <div className="row d-flex justify-content-center" style={{ marginTop: "23px" }}>
                                    <a href=" https://stories.leader.codes/bloger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17.5" height="20" viewBox="0 0 17.5 20">
                                ...
                                <div className="row d-flex justify-content-center" style={{ marginTop: "25px" }}>
                                    <a style={{ color: "#F7B500" }} href="https://leader.codes/forms/rC8XjJ3sJoUfGqKmqsURsWfe3bS2/new">
                                ...
                                <div className="row d-flex justify-content-center" style={{ marginTop: "23px" }}>
                                    <a style={{ color: "#6236FF" }} href="https://qoutes.leader.codes/">
                            ...
                            <div className="col" id="leftNavTitls" hidden={this.state.navLeft}>
                                <div className="row" ><a style={{ color: "#3598F4" }} href="https://box.leader.codes/simdsMrrcJdpQgta8kgXyQBdDFy2"> Leader Box</a></div>
